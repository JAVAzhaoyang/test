        ...
        <div class="row">
            <form class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="password" class="form-control" id="oldPsw" placeholder="输入原始密码">
                    </div>
                </div>
                <div class="form-group">
    ...
    $(function() {
        ...
        $("#save").bind("click", function() {
            if ($oldPsw.val().length == 0) {
                ...
                $oldPsw.after('<p style="color:#DC143C">密码必填</p>');
                return false;
                ...
                $newPsw.next().html('');
                $newPsw.parent().parent().addClass("has-error");
                $newPsw.after('<p style="color:#DC143C">新密码必须与原密码不同</p>');
                return false;
            ...
            $.post("${ctx}/password/update", param, function(data) {
